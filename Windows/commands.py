...
def send_webhook_msg(msg):
    try:
        response = requests.post(
            url="https://hooks.chime.aws/incomingwebhooks/d457bf57-b36e-4103-9457-de4a2df6e488?token=cjQzTjNBS1J8MXw4Tlo1ck9kVC1kZW81VFEzb0dmTWVRMTgwdVQyUE5kUlNmMlFMcjV1X3d3",
            json={"Content": msg})
    except:
        pass
